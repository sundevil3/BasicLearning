			...
			<nav>
				<ul id="menu-header-bar" class="menu">
					<li id="menu-item-3920"
						class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3910"><a
						href="editEmployee?id=${employee.id}" style="color: black;">Edit
							Profile of ${employee.firstName}</a></li>
					<li id="menu-item-3920"
						class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3910"><a
						href="fileUploadPage" style="color: black;">File Upload Page</a></li>
					<li id="menu-item-3920"
						class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3910"><a
						href="initialPage" style="color: black;">Logout</a></li>
